...
export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M9.528 1.718a.75.75 0 01.162.819A8.97 8.97 0 009 6a9 9 0 009 9 8.97 8.97 0 003.463-.69a.75.75 0 01.981.981A10.501 10.501 0 0118 16.5a10.5 10.5 0 01-10.5-10.5c0-1.741.421-3.374 1.17-4.782a.75.75 0 01.859-.461Z"
      clipRule="evenodd"
    />
  </svg>
);
